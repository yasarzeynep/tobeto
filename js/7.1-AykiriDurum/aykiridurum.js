...
function sayfaYukle()
  {
   ...
   hata.message="bu hatayı ele alacagızzzz";
    ...
    console.log("her durumda calıstırılacak kod kesimi---1 ");
  }
 ...
 try{
  ...
  console.log("her durumda calıstırılacak kod kesimi---2 ");
 }

 try {
  document.getElementById("p1").innerHTML= "deneme, span: <span style= \"border:2px gray solid;\"> eval() denemesi>>" +eval("4-18")+"</span>";
 }
 catch (hata){

 }
 finally{
  console.log("her durumda calıstırılacak kod kesimi----3 ");
 }
